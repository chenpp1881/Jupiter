...
class CLIP(nn.Module):
    ...
    def forward(
        ...
        if training_classifier:
            ...
            # # related information
            x1 = self.to_text_latent1(enc_text)
            x1 = self.to_text_latent2(x1)
        ...
        CLS1 = self.to_text_latent1(CLS1)
        CLS2 = self.to_text_latent1(CLS2)

        CLS1 = self.to_text_latent2(CLS1)
        CLS2 = self.to_text_latent2(CLS2)
